...
public class Recipe {
    ...
    public Recipe(String name, Cuisine cuisine, boolean vegetarian, boolean vegan, boolean meatOnly, boolean pescatarian, MealType mealType, SpiceRating spiceRating, Integer cookingTime, String instructions) {
        this.name = name;
        this.cuisine = cuisine;
        this.vegetarian = vegetarian;
        this.vegan = vegan;
